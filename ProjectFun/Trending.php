...
<div id="modal-wrapper" class="modal">
  ...
  <form class="modal-content animate" method="post" action="login.php?name='.'Trending.php'.'" onsubmit="return checkLoginForm()">
    ...
    ?>
     ...
     <table border="0 solid black" class="t1">
         ...
         <tr><th><a  style="display:block;padding:25px;text-decoration:none;color:#808000
                  ;width:213px;height:13px;font-family:Comic Sans MS;border:0px solid black;padding-top:200px;font-size:24px;" href="#"><center><img src="fire-icon-homepage.png" width="22px" height="22px" />       Trending        </center></a></th></tr>
         ...
         <tr><th><a  style="display:block;padding:25px;font-family:Comic Sans MS;text-decoration:none;color:black;width:210px;height:10px;border:0px solid black;padding-top:200px" href="Historypage.php"><center><img src="clock3.png" width="22px" height="22px" />       History        </center></a></th></tr>
...
<?php
    ...
    if(mysql_connect('localhost','root',''))
    {
        ...
        {
            $query="select video_desc.vid,video_desc.uid,views_count,name,descript,date_up,time_up,image_addr from video_desc order by views_count desc";
