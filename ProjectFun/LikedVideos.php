...
<div id="modal-wrapper" class="modal">
  ...
  <form class="modal-content animate" method="post" action="login.php?name='.'LikedVideos.php'.'" onsubmit="return checkLoginForm()">
...
@keyframes zoom {
    ...
    <br>
    <a href="Signout.php?name='.'LikedVideos.php'.'"><button  style="width:150px; margin-top:0px; margin-left:1080px; height:50px">SignOut
</button></a>
    ...
    ?>
     ...
     <table border="0 solid black" class="t1">
         ...
         <tr><th><a  style="display:block;padding:25px;text-decoration:none;color:#808000
                  ;width:213px;height:13px;font-family:Comic Sans MS;border:0px solid black;padding-top:200px;font-size:24px;" href="LikedVideos.php"><center><img src="like4.png" width="28px" height="28px" />       Liked Videos        </center></a></th></tr>
...
if($_COOKIE['login']=='true')
{
   ...
   if(mysql_connect('localhost','root',''))
   {
       ...
       {
           $query="select video_desc.vid,video_desc.uid,views_count,name,descript,date_up,time_up,image_addr,time,date from video_desc,likeunliked where video_desc.vid=likeunliked.vid and video_desc.vid in (select vid from likeunliked where uid=$uid and ulbit=1) and likeunliked.uid=$uid order by date,time;";
